...
def newuser() -> ft.Container:
    ...
    container_grupo = ft.Container(
        content=campo_grupo, bgcolor='#2b5e78', height=40
    )
    ...
    campo_senha = inputs.criar_input(
        'Senha',
    ...
    campo_confirmesenha = inputs.criar_input(
        'Confirme a senha',
    ...
    def salvar_usuario(e):
        ...
        if (
            not campo_nome.value
            or not campo_user.value
            or not campo_senha.value
            or not campo_grupo.value
            or not campo_loja.value
        ):
            ...
            resultado = usersalvedb.user_salve(
                cad_nome, cad_usuario, cad_senha, cad_grupo, cad_loja
            )
            print(resultado)
    ...
    formulario = ft.Container(
        content=ft.Column(
            controls=[
                ft.Text(
                    'Cadastro de Usuário', size=20, weight=ft.FontWeight.BOLD
                ),
                campo_nome,
                campo_user,
                campo_senha,

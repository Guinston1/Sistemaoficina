...
def add_clients(list_clients):
    ...
    def registration_new_client(e):
        ...
        tela_cadastro_clientes = (
            screenregistrationclient.screen_registration_clients()
        )
    ...
    def atualizar_list(clientes_lista, container_linha):
        ...
        header = ft.Row(
            [
                ...
                ft.Container(
                    ft.Text('SOBRENOME', size=14, weight=ft.FontWeight.BOLD),
                    expand=True,
                    width=120,
                    border=ft.border.all(1, 'black'),
                    bgcolor='#0e3249',
                ...
                ft.Container(
                    ft.Text('CPF', size=14, weight=ft.FontWeight.BOLD),
                    expand=True,
                    width=100,
                    border=ft.border.all(1, 'black'),
                    bgcolor='#0e3249',
                ...
                ft.Container(
                    ft.Text('TELEFONE', size=14, weight=ft.FontWeight.BOLD),
                    expand=True,
                    width=100,
                    border=ft.border.all(1, 'black'),
                    bgcolor='#0e3249',
                ...
                ft.Container(
                    ft.Text('ENDEREÇO', size=14, weight=ft.FontWeight.BOLD),
                    expand=True,
                    width=70,
                    border=ft.border.all(1, 'black'),
                    bgcolor='#0e3249',
                ...
                ft.Container(
                    ft.Text('BAIRRO', size=14, weight=ft.FontWeight.BOLD),
                    expand=True,
                    width=70,
                    border=ft.border.all(1, 'black'),
                    bgcolor='#0e3249',
                ...
                ft.Container(
                    ft.Text('CIDADE', size=14, weight=ft.FontWeight.BOLD),
                    expand=True,
                    width=100,
                    border=ft.border.all(1, 'black'),
                    bgcolor='#0e3249',
            ...
            line = ft.Container(
                ...
                content=ft.Row(
                    [
                        ...
                        ft.Container(
                            content=ft.Text(
                                first_name, weight=ft.FontWeight.BOLD, size=12
                            ),
                            padding=1,
                            border=ft.border.all(1, 'black'),
                            expand=True,
    ...
    def filtrar_clientes(e):
        ...
        clientes_filtrados = [
            c for c in clientes_lista if termo in c[1] or termo in c[3]
        ]
    ...
    title_campo_procurar = texts.criar_texto('Pesquisar:')
    ...
    headerup = ft.Row(
        controls=[title_campo_procurar, procurador, btn_new_client],
    )

    container_linha = ft.Container(content=headerup, margin=10)

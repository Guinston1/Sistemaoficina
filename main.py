...
def main(page: ft.Page):
    ...
    def home(user):
        ...
        screen_content = ft.Container(
            ...
            content=ft.Column(controls=[],expand=True, alignment=MainAxisAlignment.CENTER),
            expand=True,
            bgcolor="#001c32",
        ...
        def user_registration(e):
            ...
            print("Função cadastrar usuario") #printa o text para saber que selecionou a função
            screen_content.content.controls.clear()
            formulario = userregistration.newuser() #chama a função que cria os
            # componentes e salve o user no banco

            screen_content.content.controls.append(formulario) #inseri o formulario no container da tela
                    ...
                    controls=[
                        ft.MenuItemButton(
                            ...
                            style=ft.ButtonStyle(
                                ...
                                bgcolor={ft.ControlState.HOVERED: ft.Colors.BLUE_GREY_800}
                            ),
    ...
    input_login = inputs.criar_input("",prefix_icon=ft.Icons.ACCOUNT_CIRCLE, on_change=forcar_maiusculo)
    input_senha = inputs.criar_input("",prefix_icon=ft.Icons.LOCK,password=True, text_align=ft.alignment.center)
    ...
    botao_login = buttons.elevated(
        ...
        on_click=lambda e: efetuar_Login(input_login.value, input_senha.value,msg_login)
    )
